...
public class Bundle {
    ...
    public void putSerializable(String key, Serializable value) {
        androidBundle.putSerializable(key, value);
    }
     ...
     *
     * @param key to fetch.
     * @return the Serializable value associated with the given key or null if there is no string value in
     * the bundle.
     */
    @Nullable
    public Serializable getSerializable(String key) {
        return androidBundle.getSerializable(key);
    }

    public void putStringArrayList(String key, ArrayList<String> value) {
        androidBundle.putStringArrayList(key, value);
    }

    @Nullable
    public void getStringArrayList(String key) {
        androidBundle.getStringArrayList(key);
    }
