...
public class Router<I extends com.uber.rib.core.Interactor, C extends InteractorBaseComponent> {
     ...
     * its class name to namespace its saved instance stateArtist {@link Bundle} object.
     * <p>
     ...
     *
     * @param childRouter the {@link Router} to be attached.
     * @param tag         an identifier to namespace saved instance stateArtist {@link Bundle} objects.
     */
    @MainThread
