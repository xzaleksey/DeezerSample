...
public class ModernRouterNavigator<StateT extends RouterNavigatorState>
    ...
    @Nullable
    private RouterAndState<StateT> currentTransientRouterAndState;
    ...
    @Override
    public <R extends Router> R pushRetainedState(
    ...
    @Override
    public <R extends Router> R pushTransientState(
            final StateT newState,
            final AttachTransition<R, StateT> attachTransition,
            @Nullable final DetachTransition<R, StateT> detachTransition) {
     ...
     */
    private <R extends Router> R pushInternal(
            final StateT newState,
            final AttachTransition<R, StateT> attachTransition,
            @Nullable final DetachTransition<R, StateT> detachTransition,
